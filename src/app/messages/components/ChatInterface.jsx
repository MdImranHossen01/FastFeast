...
export default function ChatInterface({ restaurant, owner }) {
  ...
  const fetchRooms = async () => {
    try {
      const res = await fetch(`/api/chat/rooms?restaurantId=${restaurant?._id || ''}`);
            ...
            <div className="p-4 border-t border-gray-200">
              <div className="flex items-center space-x-2">
                ...
                <button
                  ...
                  className="p-2 bg-orange-500 text-white rounded-lg hover:bg-orange-600 disabled:bg-gray-300 disabled:cursor-not-allowed"
                >
