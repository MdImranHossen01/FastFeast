  ...
  return (
    <div>
      {pendingList.length > 0 ? (
        <div className="overflow-x-auto rounded-xl shadow-md py-2 bg-white dark:bg-gray-900">
                  ...
                  <td className="px-4 block md:table-cell py-1">
                    <div className="flex flex-col md:flex-row items-start md:items-center gap-2">
                      <div className="flex gap-2">
                        <button className="btn btn-xs md:btn-sm rounded-full border border-orange-500 dark:border-none bg-orange-50 dark:bg-orange-900/30 text-orange-500 hover:bg-orange-400 hover:text-white flex items-center gap-1">
                          <AiOutlineEye size={16} /> View
                        </button>
                        <button className="btn btn-xs md:btn-sm rounded-full border border-green-500 dark:border-none text-green-500 bg-green-50 dark:bg-green-900/30 hover:bg-green-400 hover:text-white flex items-center gap-1">
                          <AiOutlineCheck size={16} /> Approve
                        </button>
                      </div>

                      <div className="flex gap-2">
                        <button className="btn btn-xs md:btn-sm rounded-full bg-red-50 dark:bg-red-900/30 border border-red-500 dark:border-none text-red-500 hover:bg-red-400 hover:text-white flex items-center gap-1">
                          <AiOutlineClose size={16} /> Reject
                        </button>
                        <button className="btn btn-xs md:btn-sm rounded-full flex items-center gap-1 bg-gray-100 dark:bg-gray-800 border border-gray-500 dark:border-gray-600 text-gray-600 dark:text-gray-300 hover:bg-gray-500 hover:text-white">
