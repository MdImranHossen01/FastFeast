        ...
        <div>
          <div className="bg-white rounded-lg shadow-md p-6">
            {cartItems.map((item) => (
              <div
                key={item.cartItemId}
                className="flex flex-col sm:flex-row gap-4 pb-6 mb-6 border-b border-gray-200 last:border-b-0 last:pb-0 last:mb-0"
              >
            ...
            <div className="space-y-3 mb-6">
              ...
              <div className="border-t pt-3">
                <div className="flex justify-between">
                  ...
                  <span className="text-lg font-bold text-orange-500">
                    ৳{getTotalPrice() + 50 + Math.round(getTotalPrice() * 0.1)}
                  </span>
                </div>
              </div>
            </div>
