...
// NOTE: We can remove the AOS imports because AOS is now initialized globally in your layout.
// import AOS from "aos";
// import "aos/dist/aos.css";

const popularItems = [
    { id: 1, name: "Biryani", image: "https://i.ibb.co/KcyNS5wF/Biryani-in-orange-background-for-round-profile-picture.jpg", link: "/biryani" },
    { id: 2, name: "Pizza", image: "https://i.ibb.co/TxGwFfsN/Pizza-in-orange-background.jpg", link: "/pizza" },
    { id: 3, name: "Noodles", image: "https://i.ibb.co/FqHZcYX1/noodles-in-orange-background-1.jpg", link: "/noodles" },
    { id: 4, name: "Shawarma", image: "https://i.ibb.co/B2R3qXw1/shawarma-in-orange-background.jpg", link: "/shawarma" },
    { id: 5, name: "Fried Chicken", image: "https://i.ibb.co/S4pQbgpq/fried-chicken-in-orange-background.jpg", link: "/friedchicken" },
    { id: 6, name: "Sushi", image: "https://i.ibb.co/0j2RNP8V/sushi-in-orange-background.jpg", link: "/sushi" },
    { id: 7, name: "Soup", image: "https://i.ibb.co/YFkxHZnF/soup-in-orange-background.jpg", link: "/soups" },
];

const safeImage = (e) => {
  e.target.src = "https://placehold.co/100x100/FEE2E2/DC2626?text=Food";
};

// This custom hook is now safe because the whole component is client-only.
...
export default function PopularItems() {
  ...
  // --- REMOVED isClient state, it's no longer needed ---
      ...
      <div className="container px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div
            ...
            data-aos="fade-left" // AOS attributes can now be applied directly
          >
          ...
          <div
            ...
            data-aos="fade-right" // AOS attributes can now be applied directly
            style={{
              width: containerSize,
              height: containerSize,
            }}
          >
            {/* The rest of your JSX for the circular menu remains the same */}
            <div
              className="absolute rounded-full border-2 border-orange-300/50"
              style={{ width: containerRadius * 2, height: containerRadius * 2, top: "50%", left: "50%", transform: "translate(-50%, -50%)" }}
            />
            <AnimatePresence mode="wait">
              ...
              >
                ...
                >
                  <button onClick={prev} className="p-2 btn-sm cursor-pointer rounded-full bg-orange-500 hover:bg-orange-600 transition-colors shadow-lg">
                  ...
                  <button onClick={next} className="p-2 btn-sm cursor-pointer rounded-full bg-orange-500 hover:bg-orange-600 transition-colors shadow-lg">
